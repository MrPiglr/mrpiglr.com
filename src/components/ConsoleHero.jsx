    ...
    <div className="relative w-full h-[600px] flex flex-col items-center justify-center overflow-hidden border-b bg-background">
      ...
      <div className="relative z-10 container px-4 text-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tighter bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/70 min-h-[1.2em]">
             MrPiglr
          </h1>

          {/* Typing Effect Container - Fixed height (h-8/h-10) ensures text growth doesn't push content down */}
          <div className="h-8 md:h-10 flex items-center justify-center text-lg md:text-xl text-muted-foreground font-mono overflow-hidden">
            <span className="mr-2 text-primary">$</span>
            {text}
            <span className="animate-pulse ml-1 inline-block w-2 h-5 bg-primary align-middle" />
          </div>
