...
import { generateProductSchema, generateOfferSchema } from '@/lib/jsonLdSchemas';
...
function ProductDetailPage() {
    ...
    return (
      <div className="max-w-5xl mx-auto py-12 px-4">
        ...
        <div className="text-center text-red-400 p-8 glass-card rounded-2xl">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Error Loading Product</h1>
  ...
  return (
    <>
      <Helmet>
        <title>{product.title} - MrPiglr Store</title>
        <meta name="description" content={product.description?.substring(0, 160) || product.title} />
        <meta property="og:type" content="product" />
        <meta property="og:title" content={product.title} />
        <meta property="og:description" content={product.description?.substring(0, 160) || product.title} />
        ...
        {selectedVariant && (
          <script type="application/ld+json">
            {JSON.stringify(generateOfferSchema({
